...
import { type CandlestickData, ColorType, createChart, type IChartApi, type Time, CandlestickSeries, HistogramSeries } from "lightweight-charts"
...
function Chart({ height = 500 }: ChartComponentProps) {
