...
import { usePlaceOrder } from '../../hooks/web3/usePlaceOrder';
...
const BuyAndSellComponent = () => {
    ...
    return (
        <div className="w-full bg-gray-900 rounded-lg text-white shadow-lg">
            <div className="flex items-center mb-[0.9px] bg-[#151924] rounded-t-lg">
                <h2 className="text-md font-semibold px-3 py-[17px] bg-clip-text text-gray-300 uppercase">
                    Place Order
                </h2>
            </div>
            <div className=' p-3'>
                <div className="flex flex-col gap-2 mb-4">
                    <div className="flex rounded-lg border border-gray-700/50 p-0.5 bg-gray-800/30 backdrop-blur-sm">
                        <button
                ...
                <div className="mb-5 mt-6 transition-opacity duration-200">
                    {orderType === 'limit' ? (
                        <>
                            ...
                            <div className="flex items-center bg-gray-800/50 rounded-lg p-2 border border-gray-700/50 backdrop-blur-sm focus-within:border-blue-500/50 transition-colors">
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                    className="w-full pl-2 bg-transparent outline-none text-base [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none placeholder:text-gray-600"
                                />
                            </div>
                        </>
                    ) : (
                        ...
                        <div className="opacity-0 pointer-events-none">
                            ...
                            <div className="flex items-center bg-gray-800/50 rounded-lg p-2 border border-gray-700/50">
                                <CurrencyIcon type={side === 'buy' ? 'usdc' : 'eth'} />
