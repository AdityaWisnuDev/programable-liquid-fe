...
const TradingCard = () => {
    return (
        <div>
            <Tabs defaultValue="market" className="w-full bg-[#111827] rounded-xl">
                <TabsList className="flex rounded-t-lg w-full bg-[#111827] border-b border-[#19202F] h-fit p-0">
                    <TabsTrigger
                        value="market"
                        className="flex-1 text-base py-2 data-[state=active]:bg-[#111827] data-[state=active]:text-white border-b-2 data-[state=active]:border-[#0064A7] text-gray-400 hover:text-gray-200"
                    >
                        Market
                    </TabsTrigger>
                    <TabsTrigger
                ...
                <TabsContent value="market" className="mt-3">
                    <Tabs defaultValue="buy" className="w-full">
                        ...
                        <TabsTrigger value="buy" className="rounded-md data-[state=active]:bg-[#0064A7] flex flex-row gap-2 items-center">
                                <TrendingUp/> Long
                            </TabsTrigger>
                            <TabsTrigger value="sell" className="rounded-md data-[state=active]:bg-[#ff5d6e] flex flex-row gap-2 items-center">
                                <TrendingDown/> Short
                            </TabsTrigger>
                        </TabsList>
